...
type TranslatorClient interface {
	Translate(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Translation, error)
}
...
func (c *translatorClient) Translate(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Translation, error) {
...
type TranslatorServer interface {
	Translate(context.Context, *Request) (*Translation, error)
...
func (UnimplementedTranslatorServer) Translate(context.Context, *Request) (*Translation, error) {
...
func _Translator_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TranslatorServer).Translate(ctx, req.(*Request))
	}
